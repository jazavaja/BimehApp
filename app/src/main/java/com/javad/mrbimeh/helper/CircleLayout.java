...
public class CircleLayout extends RelativeLayout {
    ...
    public CircleLayout(Context context, AttributeSet attrs) {
        ...
        try {
            @SuppressLint("ResourceAsColor") int dividerColor = a.getColor(R.styleable.CircleLayout_sliceDivider, android.R.color.darker_gray);
            mInnerCircle = a.getDrawable(R.styleable.CircleLayout_innerCircle);

            if(mInnerCircle instanceof ColorDrawable) {
                @SuppressLint("ResourceAsColor") int innerColor = a.getColor(R.styleable.CircleLayout_innerCircle, android.R.color.white);
